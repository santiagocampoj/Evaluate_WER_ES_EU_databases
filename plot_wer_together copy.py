...
output_folder = "/home/aholab/santi/Documents/logs/text_analysis/EU/Whisper/LM/comparative_analysis"
...
# Save the plot
plot_path = os.path.join(output_folder, 'wer_metrics_comparison_es.png')

plt.tight_layout()
plt.savefig(plot_path, bbox_inches='tight')
plt.close()

print(f"Plot save at {plot_path}")